...
contract LandRegistry {
    ...
    mapping(string => Land[]) public landOwnedByCNIC;
    
    event LandRegistered(string indexed cnic, string physicalAddress, uint256 size);
    event LandTransferred(string indexed oldCNIC, string[] newMaleCNICs, string[] newFemaleCNICs, string indexed newTransgenderCNIC, string physicalAddress, uint256 maleSize, uint256 femaleSize, uint256 transgenderSize);
    ...
    function transferLand(
        ...
        uint256 totalMaleSize = (_size * 58) / 100;
        uint256 totalFemaleSize = (_size * 28) / 100;
        uint256 totalTransgenderSize = _size - totalMaleSize - totalFemaleSize;
        ...
        emit LandTransferred(_oldCNIC, _newMaleCNICs, _newFemaleCNICs, _newTransgenderCNIC, _physicalAddress, totalMaleSize, totalFemaleSize, totalTransgenderSize);
